...
Sub StockDataAnalysis()
    ...
    ' loop through all the sheets of the workbook
     For Each ws In ActiveWorkbook.Worksheets
       ...
       ' heading For Greatest % Increase, Greatest % Decrease, and Total Volume
        ...
        For l = 2 To LastRow_YearlyChange
            ...
            ElseIf Cells(l, 11).Value < Greatest_Decrease Then
               Greatest_Decrease = Cells(l, 11).Value
                Cells(3, 16).Value = Cells(l, 9).Value
                Cells(3, 17).Value = Cells(l, 11).Value
                Cells(3, 17).NumberFormat = "0.00%"
            ElseIf Cells(l, 12).Value > Greatest_Total_Value Then
                Greatest_Total_Value = Cells(l, 12).Value
